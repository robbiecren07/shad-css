...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    {...props}
  >
    <ChevronLeftIcon className={styles.paginationPreviousChevronLeft} />
    <span>Previous</span>
  </PaginationLink>
);
...
const PaginationNext = ({
  ...
  >
    <span>Next</span>
    <ChevronRightIcon className={styles.paginationPreviousChevronLeft} />
  </PaginationLink>
);
...
const PaginationEllipsis = ({
  ...
  <span
    ...
    {...props}
  >
    <DotsHorizontalIcon className={styles.paginationPreviousChevronLeft} />
