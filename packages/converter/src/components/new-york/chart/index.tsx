          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  styles.tooltipInner,
                  indicator === 'dot' && styles.tooltipInnerDot,
                )}
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                        ...
                        <div
                          className={cn(
                            styles.tooltipIndicator,
                            {
                              ...
                              [styles.tooltipIndicatorDashedNest]: nestLabel && indicator === 'dashed',
                            }
                          )}
                          style={
                            {
                    ...
                    <div
                      className={cn(
                        styles.tooltipInnerDiv,
                        nestLabel
                          ? styles.tooltipInnerDivNest
                          : styles.tooltipInnerDivDefault,
                      )}
                    >
                      <div className={styles.nestLabel}>
                        {nestLabel ? tooltipLabel : null}
                        <span className={styles.nestLabelInnerSpan}>
                          {itemConfig?.label || item.name}
                        </span>
                      </div>
                      {item.value && (
                        <span className={styles.nestLabelSpan}>
    ...
    return (
      <div
        ...
        className={cn(
          ...
          verticalAlign === 'top'
            ? styles.chartLegendContentTop
            : styles.chartLegendContentBottom,
          className,
        )}
      >
        {payload.map((item) => {
