...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className={styles.selectTriggerChevronDown} />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className={styles.selectScrollUpButtonChevronUp} />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className={styles.selectScrollUpButtonChevronUp} />
  </SelectPrimitive.ScrollDownButton>
));
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          ...
          position === 'popper' && styles.selectContentViewport,
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
  ...
  >
    <span className={styles.selectItemSpan}>
      <SelectPrimitive.ItemIndicator>
        <Check className={styles.selectScrollUpButtonChevronUp} />
      </SelectPrimitive.ItemIndicator>
    </span>
