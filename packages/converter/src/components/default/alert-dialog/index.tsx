...
import buttonStyles from '@/registry/new-york/ui/button/button.module.css';
...
const AlertDialogHeader = ({
  ...
  <div className={cn(styles.alertDialogHeader, className)} {...props} />
);
...
const AlertDialogFooter = ({
  ...
  <div className={cn(styles.alertDialogFooter, className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonStyles.buttonBase, className)}
    {...props}
  />
));
